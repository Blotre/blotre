...
/***/ function(module, exports, __webpack_require__) {
	...
	var Authorizations = _react2['default'].createClass({
	...
	_reactDom2['default'].render(_react2['default'].createElement(Authorizations, { data: authorizations }), document.getElementById('authorizations'));
	...
	*/
	var dateToDisplay = (function () {
	    ...
	    var pad = function pad(min, input) {
	        input += '';
	        while (input.length < min) input = '0' + input;
	        return input;
	    };
